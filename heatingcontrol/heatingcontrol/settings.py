# Django settings for heatingcontrol project.
import ConfigParser
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'heatingcontrol',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '+n$wua#oas0%@rf4p6k@v1k7q_(i9cu$_iv1k#q6y)=qv$mx1i'
...
WSGI_APPLICATION = 'heatingcontrol.wsgi.application'
